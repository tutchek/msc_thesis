...
{\bf Abstrakt:} Práce řeší existující problém optimálního plánování přeskladnění zboží mezi pobočkami maloobchodní společnosti. Cílem je navrhnout systém, který na základě objednávek od zákazníků 
...
\input chaps/analysis
\input chaps/research
\input chaps/algorithms
